...
Pi Engine is developed in PHP and MySQL upon frameworks including [Zend Framework](https://github.com/zendframework/zf2), [jQuery](https://github.com/jquery/jquery), [Bootstrap](https://github.com/twbs/bootstrap), [AngularJS](https://github.com/angular/angular.js) as well as icons by [FontAwesome](http://fortawesome.github.io/Font-Awesome/icons/).

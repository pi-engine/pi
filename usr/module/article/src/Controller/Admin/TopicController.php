...
class TopicController extends ActionController
{
    ...
    public function listArticleAction()
    {
        ...
        // Get users
        $users = Pi::user()->get($userIds, ['id', 'name']);

        // Get topic details
        $rowTopicSet = $model->select([]);
        $topics      = [];
    ...
    public function pullAction()
    {
        ...
        // Get topic articles
        $rowRelation   = $modelRelation->select(['topic' => $rowTopic->id]);
        $topicArticles = [];
    ...
    public function pullArticleAction()
    {
        ...
        if ($from) {
            ...
            return $this->redirect()->toRoute(
                '',
                ['action' => 'list-article', 'message' => count($ids)]
            );
        }
    }
    ...
    public function removePullAction()
    {
        ...
        $this->getModel('article_topic')->delete(['id' => $ids]);
    ...
    public function deleteAction()
    {
        ...
        $this->getModel('article_topic')->delete(['topic' => $id]);
    ...
    public function listTopicAction()
    {
        ...
        $select     = $modelCount->select()
            ...
            ->columns(['topic', 'count' => new Expression('count(*)')])
            ->group(['topic']);

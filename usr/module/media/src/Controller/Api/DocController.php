...
class DocController extends ApiController
{
    ...
    public function addAction()
    {
        ...
        $id = Pi::api('doc', $this->module)->add($data);
    ...
    public function updateAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->update($id, $data);
    ...
    public function getAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->get($id, $attr);
    ...
    public function mgetAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->mget($ids, $attr);
    ...
    public function statsAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->getStats($id);
    ...
    public function mstatsAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->getStatsList($ids);
    ...
    public function listAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->getList(
            $where,
            $limit,
            $offset,
            $order,
    ...
    public function countAction()
    {
        ...
        $result = Pi::api('doc', $this->module)->getCount($where);

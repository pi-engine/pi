userPluginModule.config(['$routeProvider', 'piProvider',
  function ($routeProvider, piProvider) {
    //Get template url
    function tpl(name) {
      return userPluginModuleConfig.assetRoot + name + '.html';
    }
    ...
    piProvider.navTabs(userPluginModuleConfig.navTabs);
    piProvider.translations(userPluginModuleConfig.t);

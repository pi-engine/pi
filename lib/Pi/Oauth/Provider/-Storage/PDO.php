 ...
 */
class Database implements AuthorizationCodeInterface,
    UserCredentialsInterface, AccessTokenInterface,
    ClientCredentialsInterface, RefreshTokenInterface,
    JwtBearerInterface, ScopeInterface
{
    protected $db;
    protected $config;

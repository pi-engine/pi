...
class Jwt
{
    ...
    protected function verifySignature($signature, $input, $key, $algo = 'HS256')
    {
        switch($algo){
            case'HS256':
            case'HS384':
    ...
    protected function sign($input, $key, $algo = 'HS256')
    {
        switch($algo){
    ...
    protected function generateRSASignature($input, $key, $algo)
    {
